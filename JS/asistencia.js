function generarRecibo() {
  ...
  image.src = './/Assets/Images/reciboavvillas.png';
  ...
  function expandirImagen() {
    ...
    recibo.style.transform = 'scale(2)'; // Aumenta el tamaño al doble
}

// Restablecer el tamaño original cuando se toque de nuevo
function restablecerImagen() {
    const recibo = document.getElementById('recibo');
    recibo.style.transform = 'scale(1)'; // Vuelve al tamaño original
}
